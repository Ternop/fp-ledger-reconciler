...
from app.schemas import AccountCreate, AccountOut, ReconciliationSummary, TransactionIn, TransactionOut
...
def create_transaction_route(payload: TransactionIn, idempotency_key: str | None = Header(default=None, alias="Idempotency-Key")):
